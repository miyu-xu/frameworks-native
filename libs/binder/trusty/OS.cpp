...
LIBBINDER_EXPORTED void trace_begin(uint64_t, const char*) {}

LIBBINDER_EXPORTED void trace_end(uint64_t) {}
...
LIBBINDER_EXPORTED int __android_log_print(int prio [[maybe_unused]], const char* tag, const char* fmt, ...) {
