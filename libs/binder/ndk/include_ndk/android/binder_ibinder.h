 ...
 * transactionCodeToFunctionMap should have same scope as clazz.
 * API aborts on resetting/clearing the transactionCodeToFunctionMap and null parameters.
 *
 ...
 * Pointer is owned by the class and will be valid as long as class defined by
 * AIBinder_Class_define is valid. if transaction code is invalid or transactionCodeToFunctionMap
 * is not set, nullptr is returned.
 */
