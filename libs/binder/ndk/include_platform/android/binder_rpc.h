 ...
 *        ABinderRpc_Accessor_asBinder. The other process accross the binder RPC
 *        connection will have called this and passed the AIBinder* accross a
 ...
 *        'binder' argument and delegates all calls to it.
 */
