 ...
 */
typedef ARpc_Accessor* (*ARpc_AccessorProvider)(const char* instance, void* data);

/**
 * This callback is responsible deleting the `void* data` object that is passed
 * in to ARpc_addAccessorProvider for the ARpc_AccessorProvider to use. That
 ...
 * is guarenteed never to be called again.
 *
...
/**
 * Inject an ARpc_AccessorProvider callback into the process for
 ...
 *        This is called after ARpc_AccessorProvider is guarenteed to never be
 ...
 * lifetime the Accesor because it may be used by the connection info provider
 * callback..
 ...
 * \provider callback that can get the socket connection information for the
 ...
 * \return binder of the supplied accessor
 */
