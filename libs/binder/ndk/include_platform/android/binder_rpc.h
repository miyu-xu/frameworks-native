 ...
 *        valid.
 * \return nullptr on error, or pointer to the ABinderRpc_AccessorProvider that
...
ABinderRpc_AccessorProvider* _Nullable ABinderRpc_registerAccessorProvider(
        ABinderRpc_AccessorProvider_getAccessorCallback _Nonnull provider, void* _Nullable data,
 ...
 */
binder_status_t ABinderRpc_unregisterAccessorProvider(
        ABinderRpc_AccessorProvider* _Nonnull provider) __INTRODUCED_IN(36);
