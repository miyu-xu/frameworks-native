...
binder_status_t ABinderRpc_unregisterAccessorProvider(ABinderRpc_AccessorProvider* provider) {
    if (provider == nullptr) {
        ALOGE("Attempting to remove a null ABinderRpc_AccessorProvider");
