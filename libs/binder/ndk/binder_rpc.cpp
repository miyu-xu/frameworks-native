...
ARpc_ConnectionInfo* ARpc_ConnectionInfo_new(const sockaddr* addr, socklen_t len) {
    ...
    if (addr->sa_family == AF_VSOCK) {
        ...
        ALOGI("Arpc_ConnectionInfo_new found AF_UNIX. family %d, path %s", un.sun_family,
              un.sun_path);
        ...
        ALOGI("Arpc_ConnectionInfo_new found AF_INET. family %d, address %s, port %d",
