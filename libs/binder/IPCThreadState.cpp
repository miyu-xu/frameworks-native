...
status_t IPCThreadState::getAndExecuteCommand()
{
    ...
    if (result >= NO_ERROR) {
        ...
        size_t newThreadsCount = mProcess->mExecutingThreadsCount.fetch_add(1);
        ...
        newThreadsCount = mProcess->mExecutingThreadsCount.fetch_sub(1);
...
void IPCThreadState::joinThreadPool(bool isMain)
{
    ...
    mIsLooper = false;
    talkWithDriver(false);
    size_t newCount = mProcess->mCurrentThreads.fetch_sub(1);
    LOG_ALWAYS_FATAL_IF(newCount > INT32_MAX,
