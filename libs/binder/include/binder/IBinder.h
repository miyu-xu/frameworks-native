...
#pragma clang diagnostic pop
     ...
     * change events might be combined into a single one with the latest frozen
     ...
     * it has passed on.)
     */
    virtual status_t addFrozenStateChangeCallback(
            const sp<FrozenStateChangeCallback>& callback) = 0;
