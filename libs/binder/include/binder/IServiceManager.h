 ...
 * is in a seperate process from this process that wants to service the Accessor
 * binder and the communication between these two proccesses is binder RPC. This
