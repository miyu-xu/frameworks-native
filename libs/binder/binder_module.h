...
#define BR_FROZEN_BINDER _IOR('r', 21, binder_uintptr_t)
#endif // BR_FROZEN_BINDER

#ifndef BR_UNFROZEN_BINDER
// Temporary definition of BR_UNFROZEN_BINDER until UAPI binder.h includes it.
#define BR_UNFROZEN_BINDER _IOR('r', 22, binder_uintptr_t)
#endif // BR_UNFROZEN_BINDER
...
#define BR_CLEAR_FREEZE_NOTIFICATION_DONE _IOR('r', 23, binder_uintptr_t)
