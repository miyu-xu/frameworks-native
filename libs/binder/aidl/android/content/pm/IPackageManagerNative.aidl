...
interface IPackageManagerNative {
     ...
     * system.
     *
     * Note that the information returned is a subset of the information available by the
     * PackageManager API, but with the same structure.
     *
     ...
     */
    @nullable PackageInfoNative getPackageInfo(String packageName, int flags, int userId);
