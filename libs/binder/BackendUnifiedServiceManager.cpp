...
binder::Status BackendUnifiedServiceManager::getService(const ::std::string& name,
    ...
    binder::ScopedTrace trace(ATRACE_TAG_ALWAYS, "BackendUnifiedServiceManager getService ");
...
binder::Status BackendUnifiedServiceManager::getService2(const ::std::string& name,
                                                         os::Service* _out) {
    binder::ScopedTrace trace(ATRACE_TAG_ALWAYS, "BackendUnifiedServiceManager getService2 ");
...
binder::Status BackendUnifiedServiceManager::checkService(const ::std::string& name,
                                                          os::Service* _out) {
    binder::ScopedTrace trace(ATRACE_TAG_ALWAYS, "BackendUnifiedServiceManager checkService ");
    ALOGE("BackendUnifiedServiceManager checkService %s", name.c_str());
