...
#ENTRYPOINT [ "/binder_sdk/build/frameworks/native/libs/binder/tests/binderLibTestSdk" ]
#ENTRYPOINT [ "/binder_sdk/build/frameworks/native/libs/binder/tests/binderDriverInterfaceTestSdk" ]
