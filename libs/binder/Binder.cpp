...
status_t BBinder::addFreezeStateChangeCallback(const sp<FreezeStateChangeCallback>&) {
    return INVALID_OPERATION;
}

status_t BBinder::removeFreezeStateChangeCallback(const wp<FreezeStateChangeCallback>&) {
    return INVALID_OPERATION;
}
