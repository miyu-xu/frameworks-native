...
LIBBINDER_NO_DESTROY static sp<ProcessState> gProcess;
LIBBINDER_NO_DESTROY static std::mutex gProcessMutex;
...
sp<ProcessState> ProcessState::init(const char* driver, bool requireDefault) {
    ...
    LIBBINDER_NO_DESTROY static std::once_flag gProcessOnce;
...
#if !LIBBINDER_HAS_NO_DESTROY
        gProcess->incStrong(nullptr);
#endif
    });
