...
class Gralloc6Mapper : public GrallocMapper {
public:
public:
    static void preload();
    ...
    [[nodiscard]] status_t getChromaSiting(
...
class Gralloc6Allocator : public GrallocAllocator {
public:
    Gralloc6Allocator(const Gralloc6Mapper& mapper);
