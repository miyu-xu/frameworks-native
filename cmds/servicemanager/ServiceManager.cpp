...
constexpr auto kProtoServiceName =
        perfetto_protos_AndroidTrackEvent_binder_service_name_field_number;
constexpr auto kProtoInterfaceName =
        perfetto_protos_AndroidTrackEvent_binder_interface_name_field_number;
constexpr auto kProtoApexName = perfetto_protos_AndroidTrackEvent_apex_name_field_number;
