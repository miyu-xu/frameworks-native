...
public:
    ...
    binder::Status registerForNotifications(const std::string&,
        ...
        return binder::Status::
                fromExceptionCode(binder::Status::EX_UNSUPPORTED_OPERATION,
                                  "registerForNotifications is not supported for ServiceManager");
    }
    binder::Status unregisterForNotifications(const std::string&,
        ...
        return binder::Status::
                fromExceptionCode(binder::Status::EX_UNSUPPORTED_OPERATION,
                                  "unregisterForNotifications is not supported for ServiceManager");
    }
