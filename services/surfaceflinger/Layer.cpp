...
bool Layer::setBuffer(std::shared_ptr<renderengine::ExternalTexture>& buffer,
    ...
    if (!buffer) {
        ...
        // setBuffer -> cacheBuffers(by IPC delivery) -> unsetBuffer -> setBuffer, and reused the
        // same buffer in both of two setBuffer, if the first setBuffer cached buffer successfully,
        // and the second setBuffer will do cache-hit, but SF did not do anything for this buffer,
        // finally it will cause SF get a null ExternalTexture instance from ClientCache.
